...
*******************************************************************************************************************/
GameManager::GameManager()	:	m_endGame(false),
								m_state(nullptr)
...
*******************************************************************************************************************/
bool GameManager::Initialize(HINSTANCE instance, LPCSTR title, bool fullScreen, bool vSync)
{
...
*******************************************************************************************************************/
void GameManager::TemporaryState(GameState* state) { m_gameStates.push_front(state); }


/*******************************************************************************************************************
	Function that adds a permanent game state to the back of the deque (e.g. Play)
*******************************************************************************************************************/
void GameManager::PermanentState(GameState* state) { m_gameStates.push_back(state); }


/*******************************************************************************************************************
	Function that deletes the game state at the front of the deque and removes the game state from the deque
*******************************************************************************************************************/
void GameManager::RemoveState() { delete m_gameStates.front(); m_gameStates.pop_front(); }
